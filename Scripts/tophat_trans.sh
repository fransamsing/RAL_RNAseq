...
REFDIR=/scratch1/sam079/RAL_hemoRNAseq/Bowtie_index
OUTDIR=/scratch1/sam079/RAL_hemoRNAseq/Tophat_trans
...
then
    ...
    tophat -p 8 --read-mismatches 10 --read-edit-dist 10 --max-multihits 10 -o ${OUTDIR}/${SAMPLES[$i]} ${REFDIR}/P_monodon_transcriptome ${INFILES_R1} ${INFILES_R2}
else
